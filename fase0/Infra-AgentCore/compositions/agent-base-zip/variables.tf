...
# ──────────────────────────────────────────────────────────────────
# Modo zip: en fase 0 NO usamos image_uri (ECR/Docker). El zip se sube
# a un bucket S3 por package_artifact y referenciamos por bucket+key.
# ──────────────────────────────────────────────────────────────────
...
variable "runtime" {
  ...
  description = "Spec del runtime del manifest: entrypoint del zip, runtime_version, env vars."
}
